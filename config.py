...
API_ID = 10876438
API_HASH = "3e2fe9a88ec96946a42bc46233bd495b"
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="6901948904").split()))
for x in OXYGEN:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="6901948904"))
